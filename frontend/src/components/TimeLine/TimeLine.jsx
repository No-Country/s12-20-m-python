    ...
    <h3>Seguimiento de tu árbol</h3>
      <div className="timeline-item">
        ...
        <div className="timeLine-event">
            <img src={Brote} alt="" />
            <p>Al día de hoy, tu árbol ya mide 1,5 metros de altura y 10 centímetros de ancho. ¡Cuenta con muy buena salud!</p>
          </div>
      ...
      <div className="timeline-item">
        ...
        <div className="timeLine-event">
            <p>Tu árbol fue plantado, pronto vas a recibir mas noticias sobre él</p>
          </div>
      </div>
      <div className="timeline-item">
        <div className="timeline-dot"></div>
